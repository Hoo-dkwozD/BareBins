...
from barebins.shell.BinShell.BinShell import BinShell
from barebins.shellcore import BinCoreAbsClass
from utils.styles import f, s

class BinShellManager():
    """
    ...
    def __init__(self, name: str, args: Namespace):
        ...
        self.child_shell = BinShell

        self.child_shell.name = self.name
        self.child_shell.args = self.args
        self.child_shell.prompt = self.prompt
        self.child_shell.mod_prompt = self.prompt
        self.child_shell.intro = self.intro
    ...
    def _load_exit(self):
        ...
        self.child_shell.do_exit = lambda: True
    ...
    def load_flow(self, core: BinCoreAbsClass):
        """
